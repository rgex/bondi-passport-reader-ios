...
unsigned int PassportCrypto::from16bitsCharToInt(unsigned char* intChar)
{
    return ((unsigned int)intChar[0] << 8) + (unsigned int)intChar[1];
}
...
void PassportCrypto::incrementSequenceCounter(char* sequenceCounter)
{
